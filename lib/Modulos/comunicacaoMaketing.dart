...
class comunicacaoMarketing extends StatelessWidget {
  abrirUrl() async {
    const url =
        'https://www.youtube.com/watch?v=giONDI-shl0&ab_channel=GiGroupBrasil';
    launch(url);
  }
      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            Text("Estímulo 2020 | Comunicação"),
          ],
        ),
      ),
      body: Scaffold(
          ...
          child: Container(
            child: Column(
              children: [
                ...
                Center(
                  child: Text(
                    "Videos do módulo Comunicacão e Marketing",
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 19,
