...
class tecnologiaInovacao extends StatelessWidget {
  abrirUrl() async {
    const url =
        'https://www.youtube.com/watch?v=PuwydNmz5QQ&ab_channel=CanalTI';
    launch(url);
  }
          ...
          child: Container(
            child: Column(
              children: [
                ...
                Center(
                  child: Text(
                    "Videos do módulo Tecnologia e Inovação",
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 19,
