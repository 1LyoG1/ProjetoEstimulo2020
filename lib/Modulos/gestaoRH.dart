...
class gestaoRH extends StatelessWidget {
  abrirUrl() async {
    const url =
        'https://www.youtube.com/watch?v=UaCyDykAMJM&ab_channel=S%C3%B3lidesTecnologia';
    launch(url);
  }
